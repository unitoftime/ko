...
#line 109 "./tests/test.k"
void TestGlobalVariableStruct ();
#line 113 "./tests/test.k"
Point reverse (Point val );
#line 119 "./tests/test.k"
...
#line 102 "./tests/test.k"
int globA = 5;
#line 108 "./tests/test.k"
Point globPoint = { 2, 3 };
// package main
#line 3 "./tests/test.k"
int main () {
