...
func (l *Lexer) Lex() (Position, TokenType, string) {
	...
	for {
		...
		case '\n':
			...
			if l.lastToken == IDENT || l.lastToken == RPAREN || l.lastToken == RBRACE || l.lastToken == RBRACK || l.lastToken == INT || l.lastToken == FLOAT || l.lastToken == INC || l.lastToken == DEC || l.lastToken == STRING {
				l.lastToken = SEMI
				l.resetPosition()
				return l.pos, SEMI, ";"
			}
