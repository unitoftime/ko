...
Token scanToken() {
  ...
  switch (c) {
    ...
    case '!':
      return makeToken(
          scan_match('=') ? TOKEN_BANG_EQUAL : TOKEN_BANG);
    case '=':
      return makeToken(
          scan_match('=') ? TOKEN_EQUAL_EQUAL : TOKEN_EQUAL);
    case '<':
      return makeToken(
          scan_match('=') ? TOKEN_LESS_EQUAL : TOKEN_LESS);
    case '>':
      return makeToken(
          scan_match('=') ? TOKEN_GREATER_EQUAL : TOKEN_GREATER);
